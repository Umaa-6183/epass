...
<head>
  ...
  * { -webkit-box-sizing:border-box; -moz-box-sizing:border-box; -ms-box-sizing:border-box; -o-box-sizing:border-box; box-sizing:border-box; }
  ...
  input[type="text"],input[type="password"]:focus { box-shadow: inset 0 -5px 45px rgba(100,100,100,0.4), 0 1px 1px rgba(255,255,255,0.2); }
...
<?php
    ...
    if(empty($_SESSION["username"])) { ?>
      <form action="user_login.php" method="post" id="frmLogin">


        <input name="uname" placeholder="Username" type="text" value="<?php if(isset($_COOKIE["member_login"])) { echo $_COOKIE["member_login"]; } ?>">


        <input name="pass" placeholder="Password" type="password" value="<?php if(isset($_COOKIE["member_password"])) { echo $_COOKIE["member_password"]; } ?>">

        <input type="checkbox" name="remember" id="remember" <?php if(isset($_COOKIE["member_login"])) { ?> checked <?php } ?> >
        <label style="color:white" for="remember-me">Remember me</label><label style="float:right; color:white"><a href="forgot.php">Forgot Password?</a></label><br>
<br>
